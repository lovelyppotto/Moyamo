...
import BaseDropdown from '../home/BaseDropdown';
import { ResultMockData, searchResultMock } from './resultMock';
...
function GestureSearchInput({ onSearch }: GestureSearchInputProps) {
  ...
  const handleSearch = () => {
    ...
    navigate(`/search?gesture_name=${encodeURIComponent(searchTerm)}&country=${encodeURIComponent(searchCountry)}`);
  };
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="ml-4 flex-1">
                    <h3 className="text-lg font-bold dark:text-d-txt-50">
                      {result.gestureName}
                    </h3>
