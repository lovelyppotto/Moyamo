      ...
      <div className="flex flex-col h-screen overflow-hidden w-full bg-[#313131] ">
        <div className=" flex flex-col justify-center items-center h-3/4 ">
          ...
          <div className="flex justify-center ">
            ...
            <button className="text-4xl xl:text-6xl font-['DNFBitBitv2'] text-gray-200 px-[10vh] py-[1vh] rounded-xl flex justify-center items-center algin-center bg-[var(--color-lavender-rose-300)] drop-shadow-quiz animate-bounce mt-[5vh] cursor-pointer">
