...
import standingGltf from '../../assets/models/Standing.gltf?url';
...
function ModelTest() {
  return (
    <div className="h-screen w-full flex flex-col items-center justify-center bg-gray-100">
      ...
      {/* Local GLTF file test */}
      <div className="w-[500px] h-[500px] bg-white rounded-xl shadow-lg p-4 mb-8">
        <h2 className="text-xl mb-4">Local GLTF Model</h2>
        <GlbViewer url={standingGltf} />
      </div>
      ...
      <div className="w-[500px] h-[500px] bg-white rounded-xl shadow-lg p-4">
        ...
        <GlbViewer 
          url="https://moyamos3.s3.ap-northeast-2.amazonaws.com/gesture/83cf4156-95ea-4154-b32b-dd52f49ca200_handtest2.glb" 
        />
      </div>
    </div>
  );
