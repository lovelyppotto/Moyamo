    ...
    gestures: [
      {
        ...
        gesture_others: '대부분의 나라에서 비슷한 의미로 사용됨',
      ...
      },
      {
        ...
        gesture_others: '일부 서양국가에서는 생소할 수 있음',
  ...
  2: {
    ...
    gestures: [
      ...
      },
      {
        ...
        gesture_others: '대부분의 서양 국가에서 비슷한 의미로 사용',
        gesture_tmi:
  ...
  3: {
    ...
    gestures: [
      ...
      },
      {
        ...
        gesture_others: '인도에서 유래한 제스처로 전 세계적으로 사용됨',
        gesture_tmi:
      ...
      },
      {
        ...
        gesture_others: '대부분의 문화권에서 비슷한 의미로 사용',
        gesture_tmi:
    ...
    gestures: [
      {
        ...
        gesture_others: '중국 문화권 외에는 널리 사용되지 않음',
        gesture_tmi:
      ...
      },
      {
        ...
        gesture_others: '한국, 일본, 대만 등 동아시아 문화권에서 유사하게 사용',
        gesture_tmi:
      ...
      },
      {
        ...
        gesture_others: '홍콩, 대만에서도 널리 사용됨',
        gesture_tmi:
      ...
      },
      {
        ...
        gesture_others: '중국 문화권 외에는 특별한 의미가 없음',
        gesture_tmi:
    ...
    gestures: [
      {
        ...
        gesture_others: '주로 이탈리아와 지중해 국가들에서 사용됨',
        gesture_tmi:
      ...
      },
      {
        ...
        gesture_others: '전 세계적으로 비슷한 의미로 인식됨',
        gesture_tmi:
      ...
      },
      {
        ...
        gesture_others: '다른 국가에서는 다른 의미로 해석될 수 있음',
        gesture_tmi:
      ...
      },
      {
        ...
        gesture_others: '미국에서는 이탈리아계 미국인들의 영향으로 사용됨',
        gesture_tmi:
